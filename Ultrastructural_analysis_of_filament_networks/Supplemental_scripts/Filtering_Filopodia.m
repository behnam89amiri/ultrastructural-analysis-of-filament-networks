...
prompt3={'Min length of filaments (nm)','Max length of filaments (nm)','Min angle of filaments to the tip direction (deg)','Max angle of filaments to the tip direction (deg)','Min bendiness of filaments','Max bendiness of filaments','Min angle of filaments to the Zaxis (deg)','Max angle of filaments to the Zaxis (deg)'}; % filtering out filaments
...
switch AnalysisType
    ...
    case 'Multiple filopodia'
        ...
        for cellcult = 1:length(subfolders )+1
            ...
            wb = waitbar(0,['filtering the filopodia of ' CellCultures ' group...']);
            for cellnum = 1:length(files)
                try
                    ...
                    display([num2str(kfilopsAll) ' filopodia has been filtered']);
                catch  
                end
